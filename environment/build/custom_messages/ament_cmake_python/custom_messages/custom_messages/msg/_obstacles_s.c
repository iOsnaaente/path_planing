...
bool custom_messages__msg__obstacles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages.msg._obstacles.Obstacles", full_classname_dest, 40) == 0);
  }
  custom_messages__msg__Obstacles * ros_message = _ros_message;
  {  // kind
...
PyObject * custom_messages__msg__obstacles__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_messages.msg._obstacles");
