...
#include "custom_messages/msg/detail/obstacles__rosidl_typesupport_fastrtps_c.h"
...
using _Obstacles__ros_msg_type = custom_messages__msg__Obstacles;
...
static uint32_t _Obstacles__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__Obstacles(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages__msg__Obstacles;
    is_plain =
      (
...
static size_t _Obstacles__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__Obstacles(
